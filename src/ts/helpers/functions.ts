...
export function createDiv(type: string,parent: HTMLElement,content: string,className: string,setValue: any,setSrc: URL): HTMLElement {
  ...
  if (typeof setValue !== 'undefined') {
    if (newDiv instanceof HTMLInputElement || newDiv instanceof HTMLTextAreaElement || newDiv instanceof HTMLSelectElement) {
      ...
      newDiv.textContent = setValue.toString();
    }
  }
